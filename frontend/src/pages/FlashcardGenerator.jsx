...
import { FileText, Sparkles, MessageSquare, ArrowRight, Loader2 } from "lucide-react";
...
export default function FlashcardGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    // Simulate flashcard generation logic
    await new Promise(resolve => setTimeout(resolve, 2000));
    setFlashcards([
      { question: "What is Photosynthesis?", answer: "The process by which green plants use sunlight to synthesize foods from CO₂ and water." },
  ...
  return (
    <div className="p-6 min-h-screen relative overflow-hidden bg-transparent">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        {step === 'intro' && (
          ...
          >
            ...
            <div className="text-center space-y-6">
              ...
              >
                Upload documents or paste text to generate interactive flashcards. 
                Turn your notes into Q&A style cards for effective studying.
              </motion.p>
            ...
            >
              {[
                ...
                {
                  title: "Q&A Style Cards",
                  description: "Automatically creates flashcards with questions and answers.",
                  icon: FileText
                },
                {
                  title: "Save Flashcards",
                  description: "Save your flashcards and come back to revise it later.",
                  icon: MessageSquare
                }
              ].map((feature, index) => (
                <motion.div
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400">
                Paste your text or upload a document to begin creating your flashcards.
              </p>
            </div>
        ...
        {step === 'view' && (
          <div className="mt-8">
            <h2 className="text-3xl font-bold text-white mb-4">Your Flashcards</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {flashcards.map((card, index) => (
                <div key={index} className="bg-white/[0.03] backdrop-blur-xl rounded-2xl border border-white/10 p-6">
